...
/**
 * @className: com.aquatic.schedule.service.http.HttpUtil
 * @description: Http请求工具类
 * @author: wanghao/haozixiaowang@163.com
 * @date: 2017/11/21 13:22
 **/
public class HttpUtil {
    ...
    public static Map<String, String> post(String postUrl, String postParams) {
        ...
        try {
            ...
            statusCode = Integer.toString(httpURLConnection.getResponseCode());
            if (httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK) {// HTTP请求返回成功
